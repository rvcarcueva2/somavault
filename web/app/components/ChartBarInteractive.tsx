...
export function ChartBarInteractive() {
  ...
  return (
    <Card className="py-0">
      <CardHeader className="flex flex-col items-stretch border-b !p-0 sm:flex-row sm:items-center">
        <div className="flex flex-1 flex-col justify-center gap-1 px-6 pt-4 pb-3 sm:!py-0">
          <div className="flex items-center gap-2">
            <FontAwesomeIcon icon={faEye} className="text-[#C52233] w-4 h-4" />
            <CardTitle>Post Views</CardTitle>
          </div>
          <CardDescription>
            Showing total posts for the selected period
          </CardDescription>
        </div>
