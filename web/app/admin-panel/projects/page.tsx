...
const columns: Column[] = [
    ...
    { key: 'type', label: 'Type', minWidth: 'min-w-[120px]' },
    ...
    { key: 'featured', label: 'Featured', minWidth: 'min-w-[100px]' },
];
                ...
                return (
                    <div className=" pl-4 flex items-center justify-between w-[110px]">
                        ...
                        <button
                            ...
                            className="cursor-pointer w-5 h-5 flex items-center justify-center rounded hover:bg-gray-200 transition ml- shrink-0"
                            title="Change status"
                        >
                            <FontAwesomeIcon icon={faChevronDown} className="text-gray-600 w-3 h-3" />
                        </button>
                    </div>
                );
            case 'featured':
                return (
                    <div className=" pl-13 flex items-center justify-between">
                        <FontAwesomeIcon
                            icon={faCircle}
                            className={`w-3 h-3 ${item.featured ? 'text-green-500' : 'text-gray-500'}`}
                        />
                    </div>
                );
            ...
            <div className="mt-4 mb-4">
                <div className="flex justify-between items-center">
                    ...
                    <div className="flex gap-2">
                        <button className="cursor-pointer bg-[#EAB044] text-white px-4 py-2 rounded-md text-sm hover:bg-[#d49a35]">
            ...
            {isOpen && dropdownPosition && (
                ...
                >
                    {['Pending', 'Approved', 'Denied', 'Closed'].map((statusOption) => {
                        const currentItem = data.find(item => item.id === isOpen);
                            ...
                            <button
                                onClick={() => {
                                    if (pendingStatusChange) {
                                        updateStatus(pendingStatusChange.id, pendingStatusChange.newStatus);
                                        setIsStatusModalOpen(false);
                                        setPendingStatusChange(null);
                                    }
                                }}
